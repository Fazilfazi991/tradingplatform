...
export function StockDemo({symbol}:{symbol:string}){const [expanded,setExpanded]=useState<string|null>("Technical");return <><PageHeader title={`${symbol} intelligence`}>A transparent evidence stack for a synthetic five-session outlook. Not investment advice.</PageHeader><div className="content">
